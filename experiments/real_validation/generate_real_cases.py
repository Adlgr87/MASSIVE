...
CASES = [
    # ── 1. CHILE — ESTALLIDO SOCIAL (Oct 2019 - Ene 2020) ──────────────────────
    {
        ...
        "interventions": [
            {
                "date": "2019-W42",
                "label": "Evasión metro + primera protesta",
                "source": "La Tercera 18-Oct-2019",
            },
            {"date": "2019-W43", "label": "Marcha millonaria 25-Oct", "source": "Paz Ciudadana"},
            {
                "date": "2019-W44",
                "label": "Estado de emergencia + curfew",
                "source": "Decreto presidencial",
            },
            {"date": "2019-W47", "label": "Acuerdo por paz social", "source": "Congreso de Chile"},
            {
                "date": "2019-W50",
                "label": "Levantamiento estado excepción",
                "source": "Decreto presidencial",
            },
        ],
    },
    # ── 2. USA — ELECCIONES 2020 (Ene - Nov 2020) ──────────────────────────────
    {
        ...
        "interventions": [
            {
                "date": "2020-W12",
                "label": "COVID national emergency declared",
                "source": "White House",
            },
            {
                "date": "2020-W20",
                "label": "George Floyd death + BLM protests",
                "source": "CNN/Gallup",
            },
            {"date": "2020-W40", "label": "Presidential election", "source": "AP/Fox/NBC"},
            {
                "date": "2020-W44",
                "label": "Election results contested",
    ...
    # ── 3. BREXIT REFERENDUM (Ene - Jul 2016) ──────────────────────────────────
    {
        ...
        "interventions": [
            {
                "date": "2016-W12",
                "label": "Official campaign begins",
                "source": "Electoral Commission",
            },
            {"date": "2016-W20", "label": "Final TV debates", "source": "BBC/ITV"},
            {
                "date": "2016-W23",
                "label": "Referendum vote 52-48",
                "source": "Electoral Commission",
            },
    ...
    # ── 4. BRASIL — ELECCIONES 2022 (Ago - Dic 2022) ───────────────────────────
    {
        ...
        "interventions": [
            ...
            {
                "date": "2022-W42",
                "label": "Bolsonaro questions results",
    ...
    # ── 5. HONG KONG — PROTESTAS 2019 (Jun - Dic 2019) ─────────────────────────
    {
        ...
        "interventions": [
            ...
            {
                "date": "2019-W25",
                "label": "June 16 march (2M people)",
                "source": "Organizers/HKU POP",
            },
    ...
    # ── 6. FRANCIA — GILETS JAUNES (Nov 2018 - Mar 2019) ──────────────────────
    {
        ...
        "interventions": [
            {
                "date": "2018-W47",
                "label": "First Saturday blockades (287k)",
    ...
    # ── 7. COLOMBIA — PARO NACIONAL 2021 (Abr - Jun 2021) ─────────────────────
    {
        ...
        "interventions": [
            {
                "date": "2021-W16",
                "label": "Tax reform bill introduced",
                "source": "Ministerio Hacienda",
            },
    ...
    # ── 8. EGIPTO — PRIMAVERA ÁRABE (Ene - Feb 2011) ──────────────────────────
    {
        ...
        "interventions": [
            ...
            {
                "date": "2011-W08",
                "label": "Feb 11: Mubarak resignation",
    ...
    # ── 9. IRÁN — PROTESTAS MAHSA AMINI (Sep - Dic 2022) ──────────────────────
    {
        ...
        "interventions": [
            {
                "date": "2022-W37",
                "label": "Sep 13: Mahsa Amini arrested",
                "source": "Iran Human Rights",
            },
            {
                "date": "2022-W38",
                "label": "Sep 16: Amini death — protests begin",
                "source": "BBC/IHR",
            },
            {
                "date": "2022-W40",
                "label": "Internet shutdown nationwide",
                "source": "Article19/OONI",
            },
            {
                "date": "2022-W41",
                "label": "Peak intensity — all 31 provinces",
                "source": "Carnegie",
            },
        ],
    },
    # ── 10. COREA DEL SUR — CANDLELIGHT 2016-17 (Oct 2016 - Mar 2017) ─────────
    {
        ...
        "interventions": [
            ...
            {
                "date": "2016-W43",
                "label": "Oct 29: First candlelight vigil",
                "source": "Gallup Korea",
            },
            {"date": "2016-W48", "label": "Dec 9: Parliament impeachment vote", "source": "NEC"},
            {
                "date": "2017-W10",
                "label": "Mar 10: Constitutional Court upholds impeachment",
    ...
    # ── 11. ALEMANIA — PEGIDA (Oct 2014 - Dic 2016) ───────────────────────────
    {
        ...
        "interventions": [
            ...
            {
                "date": "2014-W49",
                "label": "December: marches grow to 17k",
                "source": "Sächsische Zeitung",
            },
            {
                "date": "2015-W05",
                "label": "Feb 2015: Peak attendance 25k",
...
if __name__ == "__main__":
    ...
    for case in CASES:
        ...
        print(
            f"  ✅ {case['id']:40s} | {n_ts:2d} timesteps | {n_int} interventions | {case['scenario_type']}"
        )
