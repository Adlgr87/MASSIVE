...
def calculate_social_pressure(
    agent_opinion: float,
    neighbors_opinions: list[float],
    social_pressure_weights: dict[str, float] | None = None,
    ethnic_groups: dict[str, float] | None = None,
    religious_groups: dict[str, float] | None = None,
    language_groups: dict[str, float] | None = None,
...
def calculate_demographic_strategic_force(
    ...
    neighbors_opinions: list[float],
    matrix: GamePayoff,
    demographic_matrix: Any | None = None,
    age_group: int = 0,
    **kwargs,
) -> float:
    """
    ...
    base_force = calculate_strategic_force(agent_opinion, neighbors_opinions, matrix, **kwargs)
