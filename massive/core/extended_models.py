...
def _rango(cfg: dict) -> dict:
    return _RANGOS.get(
        cfg.get("rango", "[0, 1] — Probabilístico"), _RANGOS["[0, 1] — Probabilístico"]
    )
...
def regla_sir(estado: dict, params: dict, cfg: dict) -> dict:
    ...
    Propaganda amplifies the effective infection rate beta.
